...
\authorcontributions{All authors designed research; R.A.K., M.Q.W., A.Q.B., M.B.J., T.C.S., A.P.R., and R.L.G. performed research; M.B.J. contributed new analytic tools; R.A.K., M.Q.W., A.Q.B., A.P.R., and E.B.R. analyzed data; and R.A.K., M.Q.W., A.Q.B., M.B.J., T.C.S., and E.B.R. wrote paper.}
\authordeclaration{This project was supported by grants from the National Park Service (to R.A.K.), Yosemite Conservancy (to R.A.K.), and National Science Foundation (EF-0723563, to C. Briggs; DEB-1557190, to C. Briggs; DEB-2133401, to M.Q.W; and DBI-2120084, to C. Richards-Zawacki). The authors declare no additional competing interests.}
...
\keywords{amphibians | disease | evolution | reintroduction | population recovery} 
...
\begin{figure*}
{\centering \includegraphics[width=7in]{conceptual_model_7in.pdf}}
...
\begin{figure}
{\centering \includegraphics[width=3.4in]{translocation_survival_bysiteid_3pt42in.pdf}}
...
{\centering \includegraphics[width=5.5in]{conditional_effects_plot_4pt5in.pdf}}
...
\begin{figure*}
{\centering \includegraphics[width=7in]{pop_viability_figures_for_manuscript_7in.pdf}}
...
\begin{SCfigure*}[\sidecaptionrelwidth][t!]
{\centering \includegraphics[width=4.5in]{allele_maps_4pt5in.pdf}}
...
\begin{SCfigure*}[\sidecaptionrelwidth][t!]
{\centering \includegraphics[width=4.5in]{splinewindow_manhattan_4pt5in.pdf}}
...
role in facilitating the resilience of wildlife populations. We provide
an example from the wild that suggests that evolution might produce
individuals that harbor adaptive alleles and allow population recovery
in a novel (i.e., Bd-positive) environment, and show conclusively that
individuals from these recovering populations can be used to reestablish
extirpated populations and expand the scale of natural recovery
...
permits, logistical support, and/or field assistance). We also thank the
editor and three anonymous reviewers whose input helped us improve the
manuscript. This project was supported by grants from the National Park
