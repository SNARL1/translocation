...
\cite{ceballos2015}, with important implications for ecosystem
resilience and human welfare \cite{naeem2009}. One consequence of human
alteration of the biosphere is an increase in emerging infectious
diseases \cite{jones2008, fisher2012}. Such diseases pose a severe
threat to wildlife populations \cite{daszak2000}, and have caused
dramatic declines and extinctions in a wide range of taxa, including
echinoderms, mammals, birds, and amphibians
\cite{hewson2014, samuel2015, scheele2019, cunningham2021}. Amphibians
...
\cite{luedtke2023, scheele2019}. By one estimate, hundreds of species
have experienced Bd-caused declines, and numerous susceptible taxa are
extinct in the wild \cite{scheele2019}. These impacts to global
...
emerging diseases \cite{russell2020}.

Evidence of natural recovery in the many Bd-impacted amphibian
populations is surprisingly rare \cite[for notable exceptions,
...
impacts \cite{raberg2009} and facilitate population persistence and
recovery \cite{brannelly2021}. Host immunity and evolution both play
...
\cite{garner2016, woodhams2011}. However, several aspects of the
...
against Bd infection \cite{rosenblum2012, fites2013, grogan2018a}, and
(ii) the apparent rarity of evolution of more resistant/tolerant
genotypes \cite[but see][]{savage2016, grogan2018b}. These factors
...
\cite{hammond2021, knapp2022, stockwell2008, scheele2021}. If true, the
...
\emph{Rana muscosa} and \emph{Rana sierrae} \cite{vredenburg2007}, is
emblematic of the global declines of amphibians caused by Bd
\cite{scheele2019}. Once the most common amphibian in the high
elevation portion of California's Sierra Nevada mountains
\cite[USA,][]{grinnell1924}, during the past century this frog has
disappeared from more than 90\% of its historical range
\cite{vredenburg2007}. Due to the severity of its decline and the
...
\cite{bradford1989, knapp2000} starting in the late 1800s. The arrival
of Bd in the mid-1900s and its subsequent spread \cite{vredenburg2019}
caused additional large-scale population extirpations
\cite{vredenburg2010, rachowicz2006}. These Bd-caused declines are
fundamentally different from the fish-caused declines because fish
eradication is feasible \cite{knapp1998} and results in the rapid
recovery of frog populations \cite{knapp2007, vredenburg2004}. In
contrast, Bd appears to persist in habitats even in the absence of
amphibian hosts \cite{walker2007}, and therefore represents a long-term
...
\cite{vredenburg2010}, some populations have persisted after epizootics
\cite[during which Bd infection intensity on frogs is very
high,][]{briggs2010} and are now recovering
(Figure~\ref{fig-recovery-model}) \cite{knapp2016}. Frogs in these
recovering populations show reduced susceptibility to Bd infection
\cite{knapp2016}, with infection intensity (``load'') on adults
consistently in the low-to-moderate range
\cite{briggs2010, knapp2011, joseph2018}. This reduced susceptibility
is evident even under controlled laboratory conditions
\cite{knapp2016}, indicative of host resistance against Bd infection
...
\cite{savage2016, grogan2018b}, acquired immunity \cite{grogan2018a},
...
\cite{carlson2014, searle2020}. This intriguing possibility also
...
(Figure~\ref{fig-recovery-model}) \cite{joseph2018, mendelson2019}.
...
mortality (Figure S2)
\cite{joseph2018, vredenburg2010}. Although it is possible that the
...
\cite[for an example in MYL frogs, see][]{joseph2018}, the use of
...
self-sustaining \cite{joseph2018}. To extend our inferences of
...
(``naive'') \cite{zhou2015} versus in 5 populations that experienced a
...
\cite{knapp2016, vredenburg2010}. Bd-exposure histories of the 9 study
populations are based on 10-20 years of VES and Bd surveillance using
skin swabbing \cite[e.g.,][]{knapp2016, zhou2015, wilber2022}. Naive
...
failed invasions \cite[during which Bd loads remain very
...
\cite{zhou2015}. In contrast, recovering populations exist in an
enzootic state \cite{briggs2010}, characterized by smaller numbers of
adults (generally \textless{} 500), high Bd prevalence \cite[often
...
\cite{vredenburg2010}. Naive and recovering populations can be
...
MYL frogs \cite{rothstein2020, poorten2017, byrne2023}. Importantly,
...
extended MHC Class III region (HSP70, LSM2, VARS) \cite{ohta2006}.
...
\cite{daszak2000}, but broadly-applicable strategies to recover
affected species are generally lacking \cite[e.g.,][]{garner2016}.
...
amphibian reintroduction efforts \cite{dodd2005}, our success in
...
high Bd loads that lead to mass die-offs \cite{vredenburg2010}. In
...
not observed \cite[see also Figure S2]{briggs2010, knapp2011}. The differences in Bd load of frogs from
naive and recovering populations are also observed in controlled
laboratory studies \cite[see Figure 4 in][]{knapp2016}, and clearly
...
\cite{zamudio2020}. For example, the MHC plays an important role in
...
resistance against Bd \cite[e.g.,][]{savage2011, bataille2015}.
...
\cite[e.g.,][]{grogan2018b, ellison2014} and in populations differing
in Bd susceptibility \cite{grogan2018b}. This gene is also strongly
linked to disease in salmon, explaining a notable 20\% of the resistance
phenotype \cite{robledo2020, robledo2018}. We also identified a region,
...
plays an important role in innate immunity \cite{rieraromo2016}, and
...
C6 in humans \cite{soejima2005}. Based on the analysis of individual
...
regeneration \cite{fukazawa2009}. Finally, the outlier variant with the
...
interferon gene (Np-IFNi2) \cite{gan2018}, and together with GVINP1
...
achieve our ultimate goal of self-sustainability \cite{joseph2018}.
...
reintroduction programs \cite{seddon2007}, including the one we are
...
\cite{joseph2018}, Bd infection and load had detectable effects on the
survival of adults and may have influenced population establishment
(sites referred to as ``Alpine'' and ``Subalpine'' in \cite{joseph2018}
...
susceptible to Bd infection \cite{ellison2019} and as a result
experience high mortality \cite{rachowicz2006}. This high
...
characteristic of this life stage \cite{humphries2022}. In naturally
...
effects on recovering populations \cite[see also][]{hollanders2022}.
...
\cite{scheele2019}. This extraordinary impact on global amphibian
biodiversity is compounded by the lack of any effective and broadly
applicable strategies to reverse these impacts
\cite{garner2016, knapp2022}. Importantly, in addition to the natural
recovery documented for MYL frogs \cite{knapp2016}, other amphibian
species are also showing evidence of post-epizootic recovery in the
presence of Bd \cite{scheele2017, voyles2018} and suggest the
...
\cite{knapp2016}, and results from population genetic analyses
\cite{poorten2017}. The populations that we selected contained hundreds
...
Bd-caused declines \cite{knapp2016}. As is typical for recovering MYL
...
\(\approx\) 5.78 copies)\cite{vredenburg2010, joseph2018}. Recipient
...
\cite{knapp2005}. At the beginning of this study, we had a relatively
...
provide estimates of relative abundance \cite{knapp2000}.
...
\cite{joseph2019} and using R Statistical Software
\cite[v4.4.4,][]{rsoftware2022} (see \textbf{Supporting Information -
...
superpopulation made up of real and pseudo-individuals \cite[see][ for
...
\cite{gelman2013, gabry2019}. Included predictor variables describe
...
\cite{rstanarm2022} and R Statistical Software
\cite[v4.4.4,][]{rsoftware2022}. For all models, we used default,
...
\cite{vehtari2016}, as implemented by the loo package
\cite{vehtari2022}. (See \textbf{Supporting Information - Frog
...
\cite[see \textbf{Supporting Information - Frog population recovery -
...
high prevalence \cite{joseph2018}, and (ii) host density does not seem
to play a significant role in multi-year Bd infection dynamics in this
system \cite{wilber2022}. Thus, ignoring Bd infection dynamics and
...
We collected DNA samples via buccal swabbing \cite{broquet2007} from 53
...
by variation in frog genotypes across latitude \cite{byrne2023}, we
...
capture assay as described in \cite{byrne2023}. Briefly, genomic
...
\cite{chen2018} and aligned to the \emph{Rana muscosa} genome (NCBI
SRA: SRS6533475 \cite{hon2020}), with repetitive elements masked using
bwa (``mem'' mode) \cite{li2013}. Exact PCR duplicates were marked
using Picard. Variants were then called following GATK best practices
(v.4.2.0.0 \cite{van2020}). Briefly, raw variants were called for each
...
\cite{jombart2008}. To detect regions of the genome that differed
...
\cite{zhou2014}. GEMMA calculates and incorporates a relatedness matrix
...
the bedtools ``getfasta'' function \cite{quinlan2010}. Next, we
re-annotated each sequence using BLAST to get the predicted gene
location based on the closest annotated reference \cite{altschul1997}.
...
reference using Geneious \cite{kearse2012}. After ensuring proper
...
(98\% of all SNPs) using VCFtools \cite{danecek2011}. Next, we
...
\cite{beissinger2015} to conduct a splined discrete window analysis for
...
methods \cite{beissinger2015}. This method also calculates a
