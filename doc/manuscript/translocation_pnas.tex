...
critical for the conservation of biodiversity. One possibility is
evolutionary modification that restores positive growth to declining
populations (``evolutionary rescue''). Individuals from these rescued
populations could also be used to reestablish exinct populations. We
evaluated both possibilities in a once-common frog species driven to the
brink of extinction by a disease that has devastated global amphibian
biodiversity and for which few options exist to reverse its impacts. We
found that frogs have evolved increased resistance to infection,
...
in biodiversity conservation amidst unprecedented global change.}
...
altered environment. This process of rapid evolutionary change that
...
populations. We evaluated this scenario using the once-common mountain
