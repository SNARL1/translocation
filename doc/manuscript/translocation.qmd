...
<!--# Mark W: Pulling from the methods, we say: "Translocations of [putatively resistant] *R. sierrae* were conducted in Yosemite National Park (California, USA) as part of an effort to reestablish populations of this endangered species."  Could be a good starting sentence.  Also, as I am reading through the results, our sections do not elude to the Allie's section.  We should discuss how our sections can set-up Allie's section with a few well-chosen words throughout.  -->
...
<!--# Mark W: Regarding the above paragraph, what evidence do we have of "tolerance"? Are Bd loads significantly reduced in populations compared to epizootic levels? Can we convincingly state that the likely mechanism is more consistent with resistance or tolerance?  I ask because it would be nice to just use one of these terms in the paper and not get caught up in any resistance vs. tolerance discussions with reviewers.  -->
