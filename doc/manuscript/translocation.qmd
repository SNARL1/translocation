...
Emerging infectious diseases pose a severe threat to human, livestock, and wildlife populations. In wildlife populations, disease has been responsible for dramatic declines, extirpations, and even extinctions in mammals, birds, echinoderms, amphibians, and other taxa [@hewson2014; @samuel2015; @scheele2019; @cunningham2021]. Although the dramatic and immediate nature of disease-induced declines in wildlife has led to intensive focus on documenting, understanding, and mitigating disease impacts [@langwig2015], populations previously decimated by disease are also beginning to recover [@newell2013; @voyles2018]. Given the nascent nature of wildlife recoveries in the presence of disease, we know far less about the mechanisms driving population recovery [@brannelly2021; @russell2020] and how these mechanisms can be leveraged to re-establish host populations across large spatial scales [@mendelson2019]. In particular, for species of conservation concern as a result of disease-induced declines, demonstrating the long-term viability and feasibility of potential recovery actions in the presence of disease and elucidating the mechanisms underlying long-term recovery success remain largely absent from conservation biology [@venesky2012; @mendelson2019].

Host evolution following disease-induced declines is one mechanism by which hosts can recover [@carlson2014; @searle2020]. Evolutionary rescue describes natural host evolution whereby rapid evolutionary changes originating from variation within a host population reverse ongoing population declines [@carlson2014]. In host-pathogen systems, evolutionary rescue is more likely to occur when hosts experience repeated selection events (e.g., through re-infections), there is a persistent pathogen reservoir or frequency-dependent infection dynamics, and populations experience increased per capita birth rates at small population sizes [@golas2021]. Evolutionary changes following disease-induced declines have been repeatedly observed in wildlife populations [@savage2016; @epstein2016; @gignoux-wolfsohn2021; @holland2022], but linking these selective responses directly to population recoveries, as necessary for evolutionary rescue, remains rare. Important for conservation action, selection that promotes recoveries of focal populations can also provide sources of resistant individuals to reestablish populations extirpated following disease emergence [@joseph2018; @mendelson2019]. These so-called "recovery engines" [@mendelson2019] -- where rescued (i.e., resistant and recovered) host populations are used to successfully repatriate extirpated populations on the landscape -- are an intriguing management idea, but have not been successfully implemented in wildlife conservation efforts. <!--# Roland says: Modestly speaking, Joseph and Knapp (2018) does provide an example, and one that predates Mendelson (2019) paper. -->

<!--# Example text with more specific examples: black-lipped abalone populations suffering from herpes virus [@holland2022], little brown bat populations suffering from white-nose syndrome [@gignoux-wolfsohn2021], Tasmanian devils suffering from facial tumor disease [@epstein2016], and amphibian populations suffering from chytridiomycosis [@savage2016]-->

<!--# P3: In this paragraph, I took a broader approach than what was originally outlined (which focused on fitness benefits extending beyond natal environment). I'm happy to revisit this approach as necessary. Also, can we use "reduced susceptibilty" strategically (especially in Results) to avoid potential pitfalls associated with resistance, tolerance, and our lack of understanding of what actual mechanism underlies lower Bd loads and higher frog survival?  -->
...
<!--# Likely need an introductory few sentences to put the translocations in the proper context. -->
...
<!--# Suggested text to wrap this section up and build into the next two sections: Overall, our analyses show that putatively resistant frogs can maintain the benefits of resistance (i.e., minimal Bd-induced mortality despite ongoing infection) in non-natal habitats. Moreover, in three locations where longer mark-recapture time series allow us to assess the survival of adults recruited to the population due to the breeding of translocated individuals, naturally recruited adults had equivalent or higher survival probabilities than the originally translocated adults. These results show that putative resistance in non-natal habitats is maintained across generations of frogs, suggesting that acquired, heritable resistance in donor populations could promote the long-term viability of translocated populations.  We test these claims in the following sections. -->
...
<!--# Likely need an introductory few sentences to put the viability analyses in the proper context.  Mark W: I have made an attempt at this. -->
