...
In addition, the moderate Bd loads that characterized frogs following translocation (@fig-bdload-beforeafter SI) and relatively high survival of frogs in numerous translocated cohorts (@fig-translocation-survival) suggests that frogs trasnslocated from recovering populations can maintain the benefits of resistance/tolerance in non-natal habitats.
