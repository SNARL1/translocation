...
- State transition matrix for natural recruits
- State transition matrix for introduced individuals
- Parameter model description
- Priors
- Specification of the joint distribution (possible diagram of the DAG)
