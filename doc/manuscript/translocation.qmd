...
<!--# render to pdf using `quarto render doc/manuscript/translocation.qmd --to pdf` -->
...
Additional details on methods used to estimate Bd loads are provided in the SI Appendix.
...
We identified specific alleles and genomic regions showing signatures of selection between adjacent Bd-naive and recovering MYL frog populations, consistent with strong selection following Bd exposure.
