...
Berkeley, Berkeley, CA, 94720-3114
...
Here, we report the results of a greatly expanded MYL frog reintroduction effort, a long-term viability modeling, and an associated analysis to evaluate genomic signatures of selection following MYL frog exposure to Bd.
...
<!--# The following point was made in the original outline but is not included in P3, P4, or P5. Could be useful to include when introducing translocations in Results: Translocation of individuals from putatively resistant populations to sites that were formerly occupied but from which populations were extirpated by disease provides a way to disentangle the contributions of natal environment and host genetics on host persistence and recovery. -->

### Results

<!--# Let's revisit whether the selection results should go here or at the end of the results. Putting those results here would reduce the need to describe populations as "putatively resistant". Mark W: Agreed. -->
...
<!--# Mark W: As I am reading through the results, our sections do not allude to the Allie's section.  We should discuss how our sections can set-up Allie's section with a few well-chosen words throughout.  -->
...
<!--# To help constrain the possible values of omega, add information about recruitment probability observed in the study populations? Because we don't have accurate counts of subadults, can we even provide rough estimate of recruitment probability?  Mark W here: This would be great. If we have even ballpark estimates of \omega it would be useful to include.-->
