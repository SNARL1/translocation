...
-   Evolutionary rescue can be difficult to detect, and this complicates our understanding of the potential importance of evolutionary rescue in allowing the persistence and recovery of host populations following disease emergence (Eskew et al. 2021, Lilley et al. 2020). <!--# Maybe move this to the Discussion? -->

-   Important for conservation action, evolutionary rescue not only promotes recoveries of focal populations (Gignous-Wolfsohn et al. 2021), but can also provide sources of resistant individuals to reestablish populations extirpated following disease emergence (Mendelson et al. 2019, Joseph and Knapp 2018).
