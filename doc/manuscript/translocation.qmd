...
| $\sigma_{L_2}$, Yearly survival probability of year 2 tadpoles            | 0.7                  | Estimated from field data, observations, and natural history knowledge |
| $\sigma_{L_3}$, Yearly survival probability of year 3 tadpoles            | 0.7                  | Estimated from field data, observations, and natural history knowledge |
...
| $p_{L_1}$, Probability of a year 1 larvae remaining as a larvae           | 1                    | Estimated from field data, observations, and natural history knowledge |
| $p_{L_2}$, Probability of a year 2 larvae remaining as a larvae           | 0.25                 | Estimated from field data, observations, and natural history knowledge |
| $p_{J_1}$, Probability of a year 1 juvenile remaining as a juvenile       | 0.25                 | Estimated from field data, observations, and natural history knowledge |
