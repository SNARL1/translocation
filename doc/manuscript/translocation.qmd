...
-   In wildlife populations, disease has been responsible for dramatic declines, extirpations, and even extinctions in mammals, birds, echinoderms, amphibians, and other taxa \[Scheele, Avain Malaria, Black-footed ferrets, sea stars, etc.\].

-   While the dramatic and immediate nature of disease-induced declines in wildlife has led to intensive focus on documenting, understanding, and mitigating negative disease impacts (citations), populations previously decimated by disease are also beginning to recover (citations).
...
P2: Host evolution following disease-induced declines is one mechanisms through which hosts can recover (Carlson et al. 2014, TREE, Searle et al. 2020).

-   Evolutionary rescue is a type of natural host evolution where rapid evolutionary changes originating from variation within a host population reverse ongoing population declines (Carlson).
...
-   Important for conservation action, evolutionary rescue not only promotes recoveries of a focal populations, but can also provide sources of resistant individuals to reestablish populations extirpated following disease emergence (Mendelson et al. 2019, Joseph and Knapp 2018).

P3: For resistant populations to contribute to landscape-scale species recovery, the fitness benefits gained through selection should manifest beyond the natal environment, allowing for the long-term growth and persistence of incipient populations in novel environmental conditions.

-   Translocations of individuals from putatively resistant populations to formerly-occupied-but-now-extirpated habitats provides a way to disentangle the contributes of natal environmental and host genetics on host persistence recovery.

-   Something here about previous work with translocations and disease.

-   Simply put, resistant hosts that demonstrate disease resistance, population growth, and long-term viability in non-natal environments provide a means promote species recovery at a landscape-scale.

P4: Description of MYL frog species complex, impacts of Bd, and evidence of recent recovery.

P5: Here, we combine X translocations of resistant MYL populations, X longitudinal surveys, mark-recapture analysis, and population modeling to demonstrate that resistant populations of an endangered amphibian species can recover and persist across a landscape of disease.

-   We then use genetic evidence to demonstrate that observed disease resistance is likely a result of selection and argue evolutionary rescue is a strong candidate mechanism for emergence of this resistance based on five lines of evidence.

1.  Epidemiological conditions in MYL-Bd systems X, Y, and Z are conducive to evolutionary rescue.
2.  Differences in allele frequencies exist between Bd-naive and recovering populations
