...
Fig. 1). Nonetheless, for the other 6 genes
we still found a statistically significant signal of selection in 2 of
the 3 genetic clusters (containing populations 6, 7, 8, and 9;
Fig. 1, Figure~\ref{fig-selectionresults} A
...
\caption{\label{fig-selectionresults}Evidence for selection of
...
{\centering \includegraphics[width=0.85\textwidth]{figures/map_translocation_points.png}
...
{\centering \includegraphics[width=0.85\textwidth]{figures/mcmc_areas_m2b.png}
...
{\centering \includegraphics[width=0.85\textwidth]{figures/bdload_beforeafter.png}
...
log\textsubscript{10} scale; see SI text for details). Box plot details
are as in Fig. 4.}
...
{\centering \includegraphics[width=0.85\textwidth]{figures/mcmc_areas_m1d.png}

}

\caption{\label{fig-survival-postdens}Evidence that Bd load in not an
...
{\centering \includegraphics[width=0.85\textwidth]{figures/compare_surv_probs.jpg}
...
probabilities for adults translocated to each of three sites versus
adults that were naturally recruited at each site (as a result of
...
{\centering \includegraphics[width=0.85\textwidth]{figures/pop_viability_figures_for_supp.jpg}
