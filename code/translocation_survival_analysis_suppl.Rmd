...
-  Rescale bd_load, center period variable. 
-  Compare loads at time of translocation to those from CMR years 0 and 1. Exclude years > 1.
-  Possible models: 
  -  bd_load ~ period + (1 | pit_tag_ref) + (1 | translocation_id)
  -  bd_load ~ period + (1 | pit_tag_ref) + (1 | site_id)
