...
## Evaluate effect of frog size independent of donor population

-   Model m1d from `translocation_survival_analysis.Rmd` but using data subset where donor = 72996
...
ggsave(here::here("doc", "manuscript", "figures", "bdload_beforeafter.png"), width = 5, height = 3)
```
...
## Calculate parameters for viability analysis
...
-   Use 2nd chunk when connecting via SSH.
