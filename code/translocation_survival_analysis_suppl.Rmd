...
-  site_id1: Assigned 5-digit site identifier for a collection of nearby sites utilized by a frog population.
-  translocation_id: Unique identifier for each translocation.  
-  visit_date: Date on which translocation/survey was conducted.  
...
-  bd_load: Bd infection intensity determined from skin swab sample, units are number of ITS1 copies * 80. 
